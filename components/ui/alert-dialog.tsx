...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(
      cva().variants?.variant === "default" ? "bg-primary text-primary-foreground hover:bg-primary/90" : "",
      className,
    )}
    {...props}
  />
