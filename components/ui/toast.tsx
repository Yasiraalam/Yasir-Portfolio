...
const Toast = React.forwardRef<React.ElementRef<typeof ToastViewportPrimitive>, ToastProps>(
  ({ className, variant, ...props }, ref) => {
    return <ToastViewportPrimitive ref={ref} className={cn(toastVariants({ variant }), className)} {...props} />
  },
)
Toast.displayName = ToastViewportPrimitive.displayName
